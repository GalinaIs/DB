...
INSERT INTO `countries` VALUES (2,'Мексика'),(1,'Россия');
...
CREATE TABLE `regions` (
  ...
  KEY `foreign_key_country_id` (`country_id`),
  CONSTRAINT `foreign_key_country_id` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON UPDATE CASCADE
...
INSERT INTO `regions` VALUES (1,1,'Московская область'),(2,1,'Ростовская область'),(3,2,'Федеральный округ'),(4,2,'Герреро');
...
-- Dump completed on 2018-11-30 13:31:34
